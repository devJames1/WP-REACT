...
function load_scripts() {
    wp_enqueue_script( 'wp-react-tutorial', WPRT_URL . 'build/static/js/bundle.js', ['jquery', 'wp-element', 'react'], wp_rand(), true);
    //localize variables
...
require_once WPRT_PATH . 'classes/class-create-settings-route.php';
